...
function Movements() {
  const location = useLocation(); // Hook de react-router para acceder a parametros de la URL
    ...
    <div className="movements container-fluid">
      ...
      <div className="movements__row row">
        ...
        <div className="movements__form__col col-9 p-5">
          ...
          <MovementForm className="movements__row__form-movementform" movementType={movementType} />
        </div>
      </div>
    </div>
  )
